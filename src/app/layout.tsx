...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://cdn.jsdelivr.net/gh/darlynton/electorate@main/public/meta-image.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Nigeria's definitive politician accountability and transparency platform.",
    images: ["https://cdn.jsdelivr.net/gh/darlynton/electorate@main/public/meta-image.jpg"],
