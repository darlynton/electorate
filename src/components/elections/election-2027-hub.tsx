...
function partyShortLabel(party: string | null | undefined) {
  return party?.match(/\(([A-Z]+)\)/)?.[1] ?? party ?? 'Party';
}

function partyBadgeClass(party: string | null | undefined) {
  const normalizedParty = partyShortLabel(party);
